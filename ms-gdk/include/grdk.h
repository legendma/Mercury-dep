...
#define _GRDK_MM                 06
#define _GRDK_QFE_NUM            2            /* QFE version used in comparisons */
#define _GRDK_QFE                02        /* This goes into the 6 digit edition */
#define _GRDK_FULLYY             2024
#define _GRDK_EDITION            240602
...
#define _GRDKVER_PRODUCTBUILD_QFE        4312
#define _GRDKVER_PRODUCTBUILDVER_FULL    10.0.25398.4312
...
#pragma comment(linker, "/include:_XBLD_GRDK_NAME_240602")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_NAME_240602)[] = "_xbld_edition_name=GRDK," _GRDK_VER_STRING;
/* Leaving this variable for backwards compatibility but only need the edition-specific one preserved by the linker */
...
#pragma comment(linker, "/include:_XBLD_GRDK_PRODUCTBUILDVER_FULL_240602")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_PRODUCTBUILDVER_FULL_240602)[] = "_xbld_edition_full_productbuild=GRDK," GRDK_STRINGIZE(_GRDKVER_PRODUCTBUILDVER_FULL);
/* Leaving this variable for backwards compatibility but only need the edition-specific one preserved by the linker */
...
#pragma comment(linker, "/include:_XBLD_GRDK_EDITION_240602")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_EDITION_240602)[] = "_xbld_edition_sdktype=GRDK," GRDK_STRINGIZE(_GRDK_EDITION);
/* Leaving this variable for backwards compatibility but only need the edition-specific one preserved by the linker */
 __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_MSCVER)[]    = "_xbld_mscver=" _GRDK_FULLMSCVVER_;
#pragma comment(linker, "/include:_XBLD_GRDK_MSCVER_240602")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_MSCVER_240602)[]    = "_xbld_edition_mscver=GRDK," _GRDK_FULLMSCVVER_;
/* Leaving this variable for backwards compatibility but only need the edition-specific one preserved by the linker */
__declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_BUILD)[] = "_xbld_build=" GRDK_STRINGIZE(_GRDK_VER);
#pragma comment(linker, "/include:_XBLD_GRDK_BUILD_240602")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_BUILD_240602)[] = "_xbld_edition_build=GRDK," GRDK_STRINGIZE(_GRDK_VER);
...
#pragma comment(linker, "/include:_XBLD_GRDK_CLIENT_BUILD_TYPE_240602")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_CLIENT_BUILD_TYPE_240602)[] = "_xbld_edition_clientbldtype=GRDK," _GRDK_CLIENTBLDMODE;
#endif
