...
#define _GRDK_FULLYY             2023
#define _GRDK_EDITION            230603
...
#define _GRDKVER_PRODUCTBUILD_QFE        4313
#define _GRDKVER_PRODUCTBUILDVER_FULL    10.0.22621.4313
...
#pragma comment(linker, "/include:_XBLD_GRDK_NAME_230603")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_NAME_230603)[] = "_xbld_edition_name=GRDK," _GRDK_VER_STRING;
/* Leaving this variable for backwards compatibility but only need the edition-specific one preserved by the linker */
...
#pragma comment(linker, "/include:_XBLD_GRDK_PRODUCTBUILDVER_FULL_230603")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_PRODUCTBUILDVER_FULL_230603)[] = "_xbld_edition_full_productbuild=GRDK," GRDK_STRINGIZE(_GRDKVER_PRODUCTBUILDVER_FULL);
/* Leaving this variable for backwards compatibility but only need the edition-specific one preserved by the linker */
...
#pragma comment(linker, "/include:_XBLD_GRDK_EDITION_230603")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_EDITION_230603)[] = "_xbld_edition_sdktype=GRDK," GRDK_STRINGIZE(_GRDK_EDITION);
/* Leaving this variable for backwards compatibility but only need the edition-specific one preserved by the linker */
 __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_MSCVER)[]    = "_xbld_mscver=" _GRDK_FULLMSCVVER_;
#pragma comment(linker, "/include:_XBLD_GRDK_MSCVER_230603")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_MSCVER_230603)[]    = "_xbld_edition_mscver=GRDK," _GRDK_FULLMSCVVER_;
/* Leaving this variable for backwards compatibility but only need the edition-specific one preserved by the linker */
__declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_BUILD)[] = "_xbld_build=" GRDK_STRINGIZE(_GRDK_VER);
#pragma comment(linker, "/include:_XBLD_GRDK_BUILD_230603")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_BUILD_230603)[] = "_xbld_edition_build=GRDK," GRDK_STRINGIZE(_GRDK_VER);
...
#pragma comment(linker, "/include:_XBLD_GRDK_CLIENT_BUILD_TYPE_230603")
    __declspec(allocate(".xbld")) __declspec(selectany) char underscore(XBLD_GRDK_CLIENT_BUILD_TYPE_230603)[] = "_xbld_edition_clientbldtype=GRDK," _GRDK_CLIENTBLDMODE;
#endif
